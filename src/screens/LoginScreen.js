...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    clearError();
    if (!username.trim() || !password.trim()) { shake(); return; }
      ...
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <Animated.View style={[styles.card, { transform: [{ translateX: shakeAnim }] }]}>
          ...
          <TextInput
            ...
            placeholder="Введіть логін" placeholderTextColor="#aaa"
...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    fontSize: 15, color: '#1A1A2E', borderWidth: 1, borderColor: '#E0E0E0', marginBottom: 14,
  },
  passRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 14 },
  eyeBtn: { padding: 10, marginLeft: 8 },
  loginBtn: { backgroundColor: '#3F51B5', borderRadius: 14, paddingVertical: 15, alignItems: 'center', marginTop: 4 },
  ...
  demoAvatar: { width: 44, height: 44, borderRadius: 22, justifyContent: 'center', alignItems: 'center' },
